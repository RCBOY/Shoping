    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span3 contact">
                <h2>联系SimpleOne</h2>
                <ul>
                    <li class="phone"> +8617774002567</li>
                    <li class="mobile"> +8613588469955</li>
                    <li class="email">329942954@qq.com</li>
                    <li class="email"> ztcjoe1210@gmail.com</li>
                </ul>
            </div>
...
<section class="copyrightbottom">
    <div class="container">
        <div class="row">
            <div class="span6">© 2004-2016 www.SimpleOne.com.cn All Rights Reserved. SmipleOne 版权所有</div>
