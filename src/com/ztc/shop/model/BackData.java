...
public class BackData {
    ...
    public String toString() {
        return "BackBank [r0_Cmd="+r0_Cmd +" p1_MerId="+p1_MerId+"r1_Code="+r1_Code+"r2_TrxId="+r2_TrxId+"r3_Amt="+r3_Amt+"r4_Cur="+r4_Cur+"r5_Pid="+r5_Pid+"r6_Order="+r6_Order+"r7_Uid="+r7_Uid+"r8_MP="+r8_MP+"r9_BType="+r9_BType+"hmac="+hmac+"]";
    }
}
